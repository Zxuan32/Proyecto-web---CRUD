...
<body>
    <nav>
        ...
        <ul>
            ...
            <li><a href="#" class="pagina_actual">Proveedores</a></li>
    ...
    <form method="post">
        ...
        <select name="opcion">
            ...
            <option value="ruc_proveedor">RUC</option>
            <option value="correo">Correo</option>
        </select>
        <input type="text" placeholder="Busquemos un proveedor..." name="busqueda">
        <button type="submit" name="buscar"></button>
        <?php
        if ($resultado['tipo_usuario'] == 'ADM') {
            echo "
                    <a href='formulario_crear_proveedor.php'>
    ...
    <div class="principal">
        <table class="table table-hover table-bordered table-sm table-striped">
            <?php include '../includes/listar_proveedores.php' ?>
        </table>
    </div>
