    ...
    <div class='modal-dialog modal-dialog-centered'>
        <div class='modal-content'>
            <div class='modal-header'>
                <h5 class='modal-title' id='exampleModalToggleLabel'>Seguro que quieres dar de baja a
                    " . $nombre . " ?
                </h5>
            ...
            <div class='modal-footer'>
                <form action='../includes/dar_baja_usuario.php' method='post'>
                    <button type='button' name='editar' class='btn btn-secondary' data-bs-dismiss='modal'>Cancelar</button>
                    <button type='submit' name='borrar' class='btn btn-danger'>Dar de baja</button>
